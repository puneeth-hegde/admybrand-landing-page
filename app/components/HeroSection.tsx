...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        data-parallax="blob"
        className="absolute top-0 right-0 -translate-y-6 translate-x-6 sm:-translate-y-12 sm:translate-x-12"
      >
        <div className="w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-gradient-to-br from-blue-400/30 to-purple-500/30 dark:from-blue-500/20 dark:to-purple-600/20 rounded-full blur-2xl sm:blur-3xl" />
      </div>
      <div
        data-parallax="blob"
        className="absolute bottom-0 left-0 translate-y-6 -translate-x-6 sm:translate-y-12 sm:-translate-x-12"
      >
        <div className="w-40 h-40 sm:w-64 sm:h-64 lg:w-80 lg:h-80 bg-gradient-to-br from-cyan-400/30 to-blue-500/30 dark:from-cyan-500/20 dark:to-blue-600/20 rounded-full blur-2xl sm:blur-3xl" />
      </div>
      <div data-parallax="blob" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 bg-gradient-to-br from-indigo-400/20 to-pink-400/20 dark:from-indigo-500/15 dark:to-pink-500/15 rounded-full blur-2xl sm:blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 xl:py-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div data-animate="header" className="space-y-4 sm:space-y-6">
            ...
            >
              <button
                data-hover="button"
                className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl min-h-[48px] sm:min-h-[56px]"
              >
                Get Started
          ...
          <div data-animate="card" className="relative mt-8 lg:mt-0">
            <div className="relative">
              {/* Main Dashboard Container - Glassmorphism */}
              <div
                data-hover="card"
                className="relative bg-white/20 dark:bg-gray-800/20 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-2xl border border-white/30 dark:border-gray-700/30 overflow-hidden"
              >
                <Image
                ...
                <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-md rounded-lg shadow-lg p-2 sm:p-4 border border-white/20 dark:border-gray-700/20">
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full animate-pulse" />
                    <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200">AI Active</span>
                  </div>
                </div>

                <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 bg-white/30 dark:bg-gray-800/30 backdrop-blur-md rounded-lg shadow-lg p-2 sm:p-4 border border-white/20 dark:border-gray-700/20">
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">ROI Increase</div>
                  <div className="text-lg sm:text-2xl font-bold text-green-600 dark:text-green-400">+247%</div>
                </div>
              </div>
